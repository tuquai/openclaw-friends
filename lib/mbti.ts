...
export const QUESTION_OPTIONS = {
  ...
  communicationPreference: ["直接一点", "温柔一点", "会互相吐槽", "先尊重边界再靠近"],
  desiredBond: ["慢慢熟起来的伙伴", "朋友以上的暧昧感", "互相照顾型", "欢喜冤家", "导师 / 被带领感"],
  treatmentPreference: ["被理解", "被鼓励", "被坚定选择", "被照顾日常", "被吐槽但不冒犯", "被适度管着"],
  specialTraits: ["傲娇", "嘴硬心软", "毒舌但有分寸", "占有欲一点点", "高冷慢热", "天然直球"],
